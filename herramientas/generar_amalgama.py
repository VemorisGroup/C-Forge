...
RESOURCES = {
    ...
    "docs/CORE-DIRECTION.md": ROOT / "docs" / "CORE-DIRECTION.md",
    "docs/CORE-GRAMMAR-0.5.ebnf": ROOT / "docs" / "CORE-GRAMMAR-0.5.ebnf",
    "docs/C-FORGE-2.0-DRAFT.md": ROOT / "docs" / "C-FORGE-2.0-DRAFT.md",
    "docs/GRAMMAR-2.0-DRAFT.ebnf": ROOT / "docs" / "GRAMMAR-2.0-DRAFT.ebnf",
    "ejemplos/diseno_cforge_20.cfv": ROOT / "ejemplos" / "diseno_cforge_20.cfv",
    "bootstrap/core_lexer.cfv": ROOT / "bootstrap" / "core_lexer.cfv",
    "bootstrap/core_ast.cfv": ROOT / "bootstrap" / "core_ast.cfv",
    "bootstrap/core_parser.cfv": ROOT / "bootstrap" / "core_parser.cfv",
    "bootstrap/core_semantics.cfv": ROOT / "bootstrap" / "core_semantics.cfv",
    "bootstrap/core_runtime.cfv": ROOT / "bootstrap" / "core_runtime.cfv",
    ...
    "bootstrap/direct/cforge_macho_arm64.cfv": ROOT / "bootstrap" / "direct" / "cforge_macho_arm64.cfv",
    "bootstrap/direct/cforge_macho_arm64_core.cfv": ROOT / "bootstrap" / "direct" / "cforge_macho_arm64_core.cfv",
    "bootstrap/direct/cforge_macho_arm64_core_backend.cfv": ROOT / "bootstrap" / "direct" / "cforge_macho_arm64_core_backend.cfv",
    "bootstrap/direct/cforge_pe_x64.cfv": ROOT / "bootstrap" / "direct" / "cforge_pe_x64.cfv",
    "bootstrap/direct/cforge_pe_x64_core.cfv": ROOT / "bootstrap" / "direct" / "cforge_pe_x64_core.cfv",
    "bootstrap/direct/cforge_pe_x64_core_backend.cfv": ROOT / "bootstrap" / "direct" / "cforge_pe_x64_core_backend.cfv",
    "bootstrap/fixtures/machine_control_b6.cfv": ROOT / "bootstrap" / "fixtures" / "machine_control_b6.cfv",
    "bootstrap/fixtures/machine_hello_windows_b6.cfv": ROOT / "bootstrap" / "fixtures" / "machine_hello_windows_b6.cfv",
    "bootstrap/fixtures/machine_control_windows_b6.cfv": ROOT / "bootstrap" / "fixtures" / "machine_control_windows_b6.cfv",
    "bootstrap/fixtures/machine_runtime_b6.cfv": ROOT / "bootstrap" / "fixtures" / "machine_runtime_b6.cfv",
    "herramientas/generar_macho_core.py": ROOT / "herramientas" / "generar_macho_core.py",
    "herramientas/generar_pe_core.py": ROOT / "herramientas" / "generar_pe_core.py",
    "tests/test_bootstrap_b6_macho_core.py": ROOT / "tests" / "test_bootstrap_b6_macho_core.py",
    "tests/test_bootstrap_b6_pe.py": ROOT / "tests" / "test_bootstrap_b6_pe.py",
    "tests/test_bootstrap_b6_pe_core.py": ROOT / "tests" / "test_bootstrap_b6_pe_core.py",
    "tests/test_bootstrap_b6_runtime_values.py": ROOT / "tests" / "test_bootstrap_b6_runtime_values.py",
    "tests/test_bootstrap_b5.py": ROOT / "tests" / "test_bootstrap_b5.py",
    ...
    "bootstrap/fixtures/semantics_b2_driver.cfv": ROOT / "bootstrap" / "fixtures" / "semantics_b2_driver.cfv",
    "bootstrap/fixtures/emitter_b3_driver.cfv": ROOT / "bootstrap" / "fixtures" / "emitter_b3_driver.cfv",
    ...
    "herramientas/vscode-cforgev/extension.js": ROOT / "herramientas" / "vscode-cforgev" / "extension.js",
